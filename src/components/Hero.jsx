...
const Hero = () => {
    return (
        <section className="text-center mb-20 max-w-5xl mx-auto px-6 pt-32 pb-24">
            <div className="inline-flex items-center gap-2 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-full px-4 py-1 mb-8">
            ...
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-slate-500 dark:text-slate-400 leading-relaxed mb-10">
